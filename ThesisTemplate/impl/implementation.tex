...
and 100 \% of the normal instances were retained. The pre-processed datasets (see table 1). The new class distribution is also shown on figure 4.1 with details outlined in table 4.1.\newline
