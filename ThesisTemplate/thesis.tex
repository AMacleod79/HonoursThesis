...
\title{\huge{Machine Learning and The Problem of Class Imbalance in Healthcare}}
...
\listofalgorithms {Random Forest\newline SMOTE \newline Random Sampling}  %NOTE: Will generate a list of Algorithms in the Table of Contents Section
